...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ron-Tic-Tac-Toe — Neon Cyberpunk Multiplayer Game" },
      { name: "description", content: "A neon cyberpunk Tic-Tac-Toe with local, bot, and real-time online multiplayer." },
      { property: "og:title", content: "Ron-Tic-Tac-Toe — Neon Cyberpunk Multiplayer Game" },
      { property: "og:description", content: "A neon cyberpunk Tic-Tac-Toe with local, bot, and real-time online multiplayer." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://ron-tic-tac-toe.lovable.app/" },
      { property: "og:site_name", content: "Ron-Tic-Tac-Toe" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Ron-Tic-Tac-Toe — Neon Cyberpunk Multiplayer Game" },
